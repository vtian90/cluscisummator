...
public class DocumentCollection {
    ...
    public Hashtable<String, ArrayList<ArrayList<String[]>>> processedDocuments;
    ...
    public DocumentCollection() {
        ...
        processedDocuments = new Hashtable<String, ArrayList<ArrayList<String[]>>>();
    }
    ...
    public void processDocuments() throws FileNotFoundException, IOException {
        ...
        Hashtable<String, ArrayList<ArrayList<String[]>>> sentenceSplittedAllDocumentHT = new Hashtable<String, ArrayList<ArrayList<String[]>>>();

        //Praproses dokumen:
        for (String tagRhetoric : Global.rhetoricalStatusList) {
            //ArrayList dari kalimat, satu kalimat udah displit jadi satu kata yang udah di praproses
            ArrayList<ArrayList<String[]>> sentenceSplittedAllDocument = new ArrayList<ArrayList<String[]>>();             
